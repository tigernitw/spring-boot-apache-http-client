...
public class PostHttpExecutor extends BaseHttpExecutor {
    ...
    @Builder
    public PostHttpExecutor(CloseableHttpClient httpClient, HttpClientConfiguration.Endpoint endpoint, String path, HttpRequestData httpRequestData, List<HttpHeader> httpHeaders, List<QueryParam> queryParams, ObjectMapper objectMapper) {
